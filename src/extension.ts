...
function getConfigFromSettings(): SlurmConnectConfig {
  ...
  return {
    ...
    localProxyShareComputeTunnel: cfg.get<boolean>('localProxyShareComputeTunnel', false),
...
function getConfigDefaultsFromSettings(): SlurmConnectConfig {
  ...
  return {
    ...
    localProxyShareComputeTunnel: Boolean(getDefault<boolean>('localProxyShareComputeTunnel', false)),
